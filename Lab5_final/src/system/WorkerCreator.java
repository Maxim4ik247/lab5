...
public class WorkerCreator {
    ...
    public Worker updateWorker(int id, CollectionManager collectionManager) {
        ...
        setYL(location);
        setZL(location);
        setWorker(p, location, coordinates, person);
    ...
    public Worker createWorker() {
        ...
        setYL(location);
        setZL(location);
        setWorker(worker, location, coordinates, person);
    ...
    public void setWorker(Worker worker, Location location, Coordinates coordinates, Person person) {
